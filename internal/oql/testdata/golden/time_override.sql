-- SELECT count(*) FROM Log SINCE 10 days ago
-- kind=single table=logs rollup=false bucket=0s limit=10 from=2026-09-14T11:30:00Z to=2026-09-14T12:00:00Z
