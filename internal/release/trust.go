// Package release wires the shared release library (libs/release) into the backend: the trusted
// release signing keys of this build.
package release
...
// trustedKeys is set at build time: -X github.com/onuragtas/openlog/internal/release.trustedKeys=<b64>,<b64>
var trustedKeys = ""
