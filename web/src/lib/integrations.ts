...
export const INTEGRATION_IDS = ["nginx", "apache", "redis", "memcached", "mysql", "postgresql", "mongodb", "mssql", "iis", "haproxy", "rabbitmq", "elasticsearch", "jvm", "kafka", "php-fpm"] as const;
