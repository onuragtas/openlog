...
import { Activity, Bell, Boxes, Container, LayoutDashboard, LineChart, LogOut, Menu, MoreVertical, Plug, PlusCircle, Rocket, ScrollText, SearchCode, Server, Settings, Ship, X } from "lucide-react";
